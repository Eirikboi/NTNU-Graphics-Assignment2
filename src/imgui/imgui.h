...
struct ImGuiOnceUponAFrame
{
    ...
    operator bool() const { int currentFrame = ImGui::GetFrameCount(); if (RefFrame == currentFrame) return false; RefFrame = currentFrame; return true; }
};
...
struct ImFontAtlasCustomRect
{
    ...
    unsigned short  textureWidth, textureHeight;  // Input    // Desired rectangle dimension
    ...
    ImFontAtlasCustomRect()         { ID = 0xFFFFFFFF; textureWidth = textureHeight = 0; X = Y = 0xFFFF; GlyphAdvanceX = 0.0f; GlyphOffset = ImVec2(0,0); Font = NULL; }
