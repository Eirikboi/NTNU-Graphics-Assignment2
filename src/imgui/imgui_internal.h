...
struct ImGuiNextItemData
{
    ...
    float                       textureWidth;          // Set by SetNextItemWidth()
...
struct ImGuiTabItem
{
    ...
    float               textureWidth;                  // Width currently displayed
    float               ContentWidth;           // Width of actual contents, stored during BeginTabItem() call

    ImGuiTabItem()      { ID = 0; Flags = ImGuiTabItemFlags_None; LastFrameVisible = LastFrameSelected = -1; NameOffset = -1; Offset = textureWidth = ContentWidth = 0.0f; }
};
